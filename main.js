...
var _user$project$Data_Timeslot$encode = function (_p0) {
	var _p1 = _p0;
...
var _user$project$Data_Timeslot$timeString = function (_p2) {
	return A3(
...
var _user$project$Data_Timeslot$toString = function (_p3) {
	var _p4 = _p3;
	return A2(
		_elm_lang$core$Basics_ops['++'],
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			'@',
			_user$project$Data_Timeslot$timeString(_p4._1)));
};
...
var _user$project$Data_Timeslot$times = _elm_lang$core$Native_List.range(8, 16);
...
var _user$project$Data_Timeslot$decodeDay = A2(
	...
	_elm_lang$core$Json_Decode$string,
	function (x) {
		var _p6 = _elm_lang$core$String$toLower(x);
		switch (_p6) {
			case 'monday':
...
var _user$project$Data_Person$Asgl = {ctor: 'Asgl'};
var _user$project$Data_Person$Howie = {ctor: 'Howie'};
var _user$project$Data_Person$roles = _elm_lang$core$Native_List.fromArray(
	[_user$project$Data_Person$Howie, _user$project$Data_Person$Asgl, _user$project$Data_Person$Member]);
var _user$project$Data_Person$decodeRole = A2(
	...
	function (x) {
		...
		switch (_p2) {
			case 'asgl':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Data_Person$Asgl);
			case 'member':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Data_Person$Member);
			case 'howie':
				return _elm_lang$core$Json_Decode$succeed(_user$project$Data_Person$Howie);
			default:
	...
	function (f, list) {
		...
		if (_p3.ctor === '[]') {
			...
			return f(_p4) ? A2(
				_elm_lang$core$List_ops['::'],
				_p4,
				A2(_user$project$Util$takeWhile, f, _p3._1)) : _elm_lang$core$Native_List.fromArray(
				[]);
		}
	});
...
var _user$project$GroupPage$asglFirst = F2(
	function (left, right) {
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$GroupPage$Hover(
						_user$project$GroupPage$HoverPerson(_p5))),
...
var _user$project$GroupPage$viewGroup = F4(
	function (hover, index, people, _p8) {
		var _p9 = _p8;
		var _p14 = _p9._1;
		var groupErrors = A2(_user$project$Validation$validateGroup, people, _p14);
		var _p10 = function () {
			var _p11 = groupErrors;
			if (_p11.ctor === 'Err') {
				return {ctor: '_Tuple2', _0: true, _1: _p11._0};
			} else {
				return {
					ctor: '_Tuple2',
					_0: false,
		...
		var hasErrors = _p10._0;
		var errors = _p10._1;
		var highlighted = function () {
			var _p12 = hover;
			if (_p12.ctor === 'HoverPerson') {
				return A2(
					_elm_lang$core$Maybe$withDefault,
					false,
					A2(
						_elm_lang$core$Maybe$map,
						A2(_elm_lang$core$Basics$flip, _user$project$GroupPage$freeAt, _p14.time),
						A2(_elm_lang$core$Dict$get, _p12._0, people)));
			} else {
				return false;
			}
		}();
		var name = _user$project$Data_Timeslot$toString(_p14.time);
		var members = A2(
			_elm_lang$core$Dict$filter,
			F2(
				function (id, _p13) {
					return A2(_elm_lang$core$Set$member, id, _p14.people);
				}),
			people);
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(_elm_lang$core$Basics$flip, _user$project$GroupPage$Move, _p9._0)),
					_elm_lang$html$Html_Events$onMouseOver(
					_user$project$GroupPage$Hover(
						_user$project$GroupPage$HoverGroup(_p14.time))),
					_elm_lang$html$Html_Events$onMouseOut(
					_user$project$GroupPage$Hover(_user$project$GroupPage$NoHover))
				]),
			A2(
				...
				A2(
					...
					A2(
						...
						F2(
							function (a, b) {
								return A2(
									_user$project$GroupPage$asglFirst,
...
var _user$project$GroupPage$view = function (_p15) {
	var _p16 = _p15;
	var _p20 = _p16.people;
	var _p19 = _p16.hover;
	var _p18 = _p16.groups;
	var index = _user$project$Data_Group$makeIndex(_p18);
	var _p17 = _user$project$GroupPage$splitRoles(_p20);
	var leaders = _p17.leaders;
	var members = _p17.members;
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A4(_user$project$GroupPage$viewGroups, _p19, index, _p20, _p18),
				A4(_user$project$GroupPage$viewPeople, _p19, index, 'ASGLs', leaders),
				A4(_user$project$GroupPage$viewPeople, _p19, index, 'Members', members)
			]));
};
		...
		switch (_p21.ctor) {
			case 'Move':
				var groups$ = A2(
					...
					A2(_user$project$GroupPage$fixGroup, _p21._1, _p21._0),
					model.groups);
				return A2(
			...
			case 'Remove':
				var _p24 = _p21._0;
				var _p22 = index.byPerson(_p24);
				if (_p22.ctor === 'Just') {
					var _p23 = _p22._0._1;
					var people$ = A2(_elm_lang$core$Set$remove, _p24, _p23.people);
					var group$ = _elm_lang$core$Native_Utils.update(
						_p23,
						{people: people$});
					var groups$ = A3(_elm_lang$core$Dict$insert, _p22._0._0, group$, model.groups);
					return A2(
						_user$project$Util_ops['!!'],
						A2(
							_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$PersonForm$roleFromString = function (input) {
	...
	switch (_p1) {
		case 'Howie':
			return _elm_lang$core$Maybe$Just(_user$project$Data_Person$Howie);
		case 'Asgl':
			return _elm_lang$core$Maybe$Just(_user$project$Data_Person$Asgl);
		case 'Member':
...
var _user$project$PersonForm$viewGender = function (person) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Events$onInput(_user$project$PersonForm$UpdateGender)
			]),
...
var _user$project$PersonForm$viewRole = function (person) {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Events$onInput(_user$project$PersonForm$UpdateRole)
			]),
...
var _user$project$PersonPage$people = function (model) {
	var roleIs = F2(
		function (value, _p0) {
			var _p1 = _p0;
	...
	var asgls = A2(
		_elm_lang$core$List$filter,
		roleIs(_user$project$Data_Person$Asgl),
		sorted);
	var members = A2(
		_elm_lang$core$List$filter,
		roleIs(_user$project$Data_Person$Member),
		sorted);
	return A2(_elm_lang$core$Basics_ops['++'], asgls, members);
};
				...
				_elm_lang$core$List$reverse(
					A2(
						...
						A2(
							_elm_lang$core$List$map,
							pid,
							_user$project$PersonPage$people(model)))));
		} else {
			return _elm_lang$core$List$head(
				_elm_lang$core$List$reverse(
					A2(
...
var _user$project$PersonPage$moveSelectionDown = function (model) {
	var pid = function (_p11) {
		var _p12 = _p11;
		return _p12._0;
	};
	var selection = function () {
		var _p13 = model.selected;
		if (_p13.ctor === 'Just') {
			return _elm_lang$core$List$head(
				A2(
...
var _user$project$PersonPage$init = function (people) {
	return {
		ctor: '_Tuple2',
		_0: {
			people: people,
...
var _user$project$PersonPage$viewList = function (model) {
	var selected = function (id) {
		var _p15 = {ctor: '_Tuple2', _0: id, _1: model.selected};
		_v10_2:
		do {
			if (_p15.ctor === '_Tuple2') {
				if (_p15._0.ctor === 'Just') {
					if (_p15._1.ctor === 'Just') {
						return _elm_lang$core$Native_Utils.eq(_p15._0._0, _p15._1._0);
					} else {
						break _v10_2;
					}
				} else {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A2(_elm_lang$core$Basics_ops['++'], 'person-', _p18))
				]),
			_elm_lang$core$Native_List.fromArray(
				[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('ASGLs')
							]))
					]),
					asglList,
					_elm_lang$core$Native_List.fromArray(
...
var _user$project$PersonPage$update = F2(
	function (msg, model) {
		...
		switch (_p21.ctor) {
			case 'FormMsg':
				var _p22 = A2(_user$project$PersonForm$update, _p21._0, model.form);
				var form = _p22._0;
				var cmd = _p22._1;
				var fromForm = _p22._2;
				var _p23 = A2(
			...
			case 'KeyUp':
				return A2(
					...
					A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						A2(_user$project$PersonPage$updateKeyup, _p21._0, model),
						_elm_lang$core$Native_List.fromArray(
							[])),
			...
			case 'KeyDown':
				return A2(
					_user$project$Util_ops['!!'],
					A2(_user$project$PersonPage$updateKeydown, _p21._0, model),
					_user$project$PersonPage$None);
			case 'Select':
				return A2(
					_user$project$Util_ops['!!'],
					A2(_user$project$PersonPage$updateSelection, _p21._0, model),
					_user$project$PersonPage$None);
			case 'Add':
				return A2(
					_user$project$Util_ops['!!'],
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								_elm_lang$core$Random$generate,
								A2(_elm_lang$core$Basics$flip, _user$project$PersonPage$Save, _p21._0),
...
var _user$project$TimePage$asglFirst = F2(
	function (left, right) {
		var _p0 = {ctor: '_Tuple2', _0: left.role, _1: right.role};
		_v0_2:
		do {
...
var _user$project$TimePage$splitRoles = function (people) {
	return {
		leaders: A2(
			_elm_lang$core$Dict$filter,
			_user$project$TimePage$hasRole(_user$project$Data_Person$Asgl),
			people),
		members: A2(
			_elm_lang$core$Dict$filter,
...
var _user$project$TimePage$Model = F3(
	function (a, b, c) {
		return {groups: a, people: b, hover: c};
	});
...
var _user$project$TimePage$init = F2(
	function (people, groups) {
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			{groups: groups, people: people, hover: _user$project$TimePage$NoHover},
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
...
var _user$project$TimePage$viewTimeslot = F4(
	function (hover, people, _p9, timeslot) {
		...
		var mGroup = _p16.byTimeslot(timeslot);
		var groupPeople = A2(
			_elm_lang$core$Maybe$withDefault,
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_user$project$DragAndDrop$onDrop,
					_user$project$Data_Person$idDrag,
					_user$project$TimePage$Add(timeslot)),
					_elm_lang$html$Html_Events$onMouseOver(
					_user$project$TimePage$Hover(
					...
					_user$project$TimePage$Hover(_user$project$TimePage$NoHover)),
					_elm_lang$html$Html_Events$onClick(
					_user$project$TimePage$Delete(timeslot))
				]),
...
var _user$project$TimePage$view = function (model) {
	var index = _user$project$Data_Group$makeIndex(model.groups);
	var _p18 = model;
	var people = _p18.people;
	var groups = _p18.groups;
	var _p19 = _user$project$TimePage$splitRoles(people);
	var leaders = _p19.leaders;
	var members = _p19.members;
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A4(_user$project$TimePage$viewPeople, model.hover, index, 'ASGLs', leaders),
			...
			switch (_p20.ctor) {
				case 'Add':
					...
					if (_elm_lang$core$Native_Utils.eq(
						...
						var groups$ = A2(
							_elm_lang$core$Dict$map,
							A2(_user$project$TimePage$fixGroup, _p22, _p21),
							model.groups);
						return A2(
							_user$project$Util_ops['!!'],
							A2(
				...
				case 'Create':
					var _p23 = _p20._1;
					var group = {time: _p23, people: _elm_lang$core$Set$empty};
					var groups$ = A3(_elm_lang$core$Dict$insert, _p20._0, group, model.groups);
					var _v8 = A2(_user$project$TimePage$Add, _p23, _p20._2),
				...
				case 'Move':
					...
					var _p24 = {
						ctor: '_Tuple2',
						_0: A2(_elm_lang$core$Dict$get, _p26, model.groups),
						_1: index.byTimeslot(_p27)
					};
					if (((_p24.ctor === '_Tuple2') && (_p24._0.ctor === 'Just')) && (_p24._1.ctor === 'Nothing')) {
						var _p25 = _p24._0._0;
						var groups$ = A3(_elm_lang$core$Dict$insert, _p26, _p25, model.groups);
						var group$ = _elm_lang$core$Native_Utils.update(
							_p25,
							{time: _p27});
						return A2(
				...
				case 'Delete':
					var _p31 = index.byTimeslot(_p20._0);
					if (_p31.ctor === 'Just') {
						if (_elm_lang$core$Set$isEmpty(_p31._0._1.people)) {
							var groups$ = A2(_elm_lang$core$Dict$remove, _p31._0._0, model.groups);
							return A2(
								_user$project$Util_ops['!!'],
								A2(
									_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Pages$Model = F4(
	function (a, b, c, d) {
		return {page: a, people: b, groups: c, ctrlDown: d};
	});
...
var _user$project$Pages$viewNavLink = F2(
	function (page, model) {
		var selected = function () {
			var _p1 = {ctor: '_Tuple2', _0: model, _1: page};
			_v1_3:
			do {
				if (_p1.ctor === '_Tuple2') {
					switch (_p1._0.ctor) {
						case 'Person':
							if (_p1._1.ctor === 'People') {
								return true;
							} else {
								break _v1_3;
							}
						case 'Time':
							if (_p1._1.ctor === 'Times') {
								return true;
							} else {
								break _v1_3;
							}
						default:
							if (_p1._1.ctor === 'Groups') {
								return true;
							} else {
								break _v1_3;
							}
	...
	switch (_p2.ctor) {
		case 'Person':
			return A2(
				...
				_user$project$PersonPage$view(_p2._0));
		case 'Time':
			return A2(
				_elm_lang$html$Html_App$map,
				_user$project$Pages$TimeMsg,
				_user$project$TimePage$view(_p2._0));
		default:
			return A2(
				_elm_lang$html$Html_App$map,
				_user$project$Pages$GroupMsg,
				_user$project$GroupPage$view(_p2._0));
	}
};
	...
	switch (_p3.ctor) {
		case 'Person':
			return A2(
				...
				_user$project$Pages$PersonMsg,
				_user$project$PersonPage$subscriptions(_p3._0));
		case 'Time':
			return A2(
				_elm_lang$core$Platform_Sub$map,
				_user$project$Pages$TimeMsg,
				_user$project$TimePage$subscriptions(_p3._0));
		default:
			return A2(
				_elm_lang$core$Platform_Sub$map,
				_user$project$Pages$GroupMsg,
				_user$project$GroupPage$subscriptions(_p3._0));
	}
};
...
var _user$project$Pages$init = F2(
	function (people, groups) {
		var _p9 = A2(_user$project$GroupPage$init, people, groups);
		var model = _p9._0;
		var cmd = _p9._1;
		return A2(
			_elm_lang$core$Platform_Cmd_ops['!'],
			{
				page: _user$project$Pages$Group(model),
				people: people,
				groups: groups,
				ctrlDown: false
			},
			_elm_lang$core$Native_List.fromArray(
				[
					A2(_elm_lang$core$Platform_Cmd$map, _user$project$Pages$GroupMsg, cmd)
				]));
	});
	...
	switch (_p1.ctor) {
		case 'Loaded':
			return A2(
				...
				_user$project$Pages$view(_p1._0));
		case 'Loading':
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
		...
		default:
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Failed to load!')
					]));
	}
};
var _user$project$Main$subscriptions = function (model) {
	...
	if (_p2.ctor === 'Loaded') {
		return A2(
			_elm_lang$core$Platform_Sub$map,
			_user$project$Main$PageMsg,
			_user$project$Pages$subscriptions(_p2._0));
	} else {
		return _elm_lang$core$Platform_Sub$none;
	}
};
var _user$project$Main$RestoreFail = function (a) {
	return {ctor: 'RestoreFail', _0: a};
};
var _user$project$Main$RestoreData = function (a) {
	return {ctor: 'RestoreData', _0: a};
};
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p3 = {ctor: '_Tuple2', _0: msg, _1: model.state};
		switch (_p3._1.ctor) {
			case 'Loaded':
				if (_p3._0.ctor === 'PageMsg') {
					var _p4 = A2(_user$project$Pages$update, _p3._0._0, _p3._1._0);
					var pmodel$ = _p4._0;
					var pcmd = _p4._1;
					var parentMsg = _p4._2;
					var _p5 = A2(_user$project$Main$updateFromPages, parentMsg, model);
					var model$ = _p5._0;
					var cmd = _p5._1;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						...
						_elm_lang$core$Native_List.fromArray(
							[
								A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PageMsg, pcmd),
								cmd
							]));
				} else {
					return A2(
			...
			case 'Loading':
				if ((_p3._0.ctor === 'RestoreData') && (_p3._0._0.ctor === '_Tuple2')) {
					var _p8 = _p3._0._0._0;
					var _p7 = _p3._0._0._1;
					var _p6 = A2(_user$project$Pages$init, _p8, _p7);
					var pmodel = _p6._0;
					var pcmd = _p6._1;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$Main$main = {
	main: _elm_lang$html$Html_App$program(
		{
			init: _user$project$Main$init('http://localhost:8080/data.json'),
